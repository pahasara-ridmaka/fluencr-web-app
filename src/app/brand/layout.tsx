...
const navItems = [
  ...
  { href: "/brand/proposals", label: "Proposals", icon: FileText },
    ...
    <div className="flex min-h-screen bg-background">
      ...
      >
        ...
        <div className={cn("flex h-16 items-center border-b px-4", collapsed ? "justify-center" : "justify-between")}>
          {!collapsed && (
            <Link href="/brand" className="text-xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">
              Fluencr
            </Link>
          )}
          <Button
              ...
              <Button variant="ghost" className={cn("w-full", collapsed ? "justify-center p-2" : "justify-start gap-3 px-3")}>
                ...
                {!collapsed && (
                  <div className="flex-1 text-left">
                    <p className="text-sm font-medium truncate">{user?.name ?? "Brand User"}</p>
